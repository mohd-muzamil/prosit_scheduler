...
#     print("loop...")
#     for start_str in locker(gen(), dict__url=config.get("Run", "stepspersec"), timeout=180):  # 3min.
...
#                     continue
#                 speed = steps / secs  # steps / s

#                 doc_steps = doc.copy()
#                 doc_steps["hash"] = "SS" + doc["hash"][2:]
#                 doc_steps["value"] = round(speed, 8)
#                 doc_steps["attribute"] = "STEPS_S"
