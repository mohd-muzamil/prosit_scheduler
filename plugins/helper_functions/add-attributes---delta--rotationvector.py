...
# attributes = {"$in": ["rotationVector__cos_x_y_z"]}
...
#     print("loop...")
#     for start_str in locker(gen(), dict__url=config.get("Run", "rotationvec"), timeout=180):  # 3min.
...
#                 a = doc["attribute"]
#                 t = doc["measuredAt"]
#                 _, x, y, z = [float(v) for v in doc["value"]]
#                 if t0 is None:
#                     t0, x0, y0, z0 = t, x, y, z
#                     continue
...
#                 doc_d["hash"] = "RD" + doc["hash"][2:]
#                 doc_d["attribute"] = "ROTVEC_D"
